...
public class ParameterDescription
{
	...
	private void initDescription(String description, String descriptionKey, String[] names)
	{
		...
		if (!"".equals(descriptionKey))
		{
			...
			{
				// JCommander.getConsole().println("Warning: field " +
	...
	private void init(Object object, Parameterized parameterized, ResourceBundle bundle, JCommander jCommander)
	{
		...
		if (m_parameterAnnotation != null)
		{
			...
			if (m_dynamicParameterAnnotation != null)
			{
	...
	public static void validateValueParameter(@SuppressWarnings("rawtypes") Class<? extends IValueValidator> validator, String name, Object value)
	{
		try
		{
